...
const Index = () => {
    ...
    if (pageError || !pageData?.page) {
        // Handle error or page not found - redirect to 404 or show error message
        // For now, just showing a simple message
        return <div className="container mx-auto py-20 text-center">Error loading homepage content or page not found.</div>;
    }
